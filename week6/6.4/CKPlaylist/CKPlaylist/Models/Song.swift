...
extension CKRecord {
    convenience init(song: Song) {
        ...
        self.setValue(song.title, forKey: Song.titleKey)
        self.setValue(song.artist, forKey: Song.artistKey)
        self.setValue(song.playlistReference, forKey: Song.playlistReferenceKey)
