...
func lowHighPrinter(for array: [Int]) {
    ...
    for i in array {
        ...
        printStatement += x == nil ? ", getting bigger" : (i > array[index] ? ", getting bigger" : ", it's stopped growing")
...
func simplify(array: [Int]) -> [Int] {
    ...
    for i in sortedArray {
        ...
        i != sortedArray[x] ? returnArray.append(i) : sortedArray.append(x)
        y += 1
    }
    return returnArray
}

var smallArray = [0, 9, 8, 3, 3, 3, 5, 9, 5]
